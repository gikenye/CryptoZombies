...
```
git clone https://github.com/gikenye/CryptoZombies.git
```
...
This project is licensed under the GNU General Public License v3.0. See the [LICENSE](https://github.com/CryptozombiesHQ/cryptozombies-lesson-code.git/blob/master/LICENSE) file for details.
